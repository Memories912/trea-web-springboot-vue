  ...
  return (
    <>
      ...
      <main className="relative z-10 pt-24">
              ...
              {faqs.map((faq, i) => (
                <div key={i} className="page-card">
                  <button
                    ...
                    className={`faq-toggle w-full text-left glass-card rounded-xl p-5 md:p-6 transition-all ${
                      openIdx === i ? 'border-[#b8860b]/20' : ''
                    }`}
                  >
                    <div className="flex items-center justify-between gap-4">
                      <span className="text-sm md:text-base font-medium text-foreground/90">{faq.q}</span>
                      <span className="text-[#b8860b]/60 flex-shrink-0 text-xs transition-transform duration-300" style={{ transform: openIdx === i ? 'rotate(180deg)' : 'rotate(0deg)' }}>
                        ▼
                      </span>
                    </div>
                    <div>
        ...
        <section className="section-padding pt-0">
          <div className="section-container">
            <div className="page-cta text-center flowing-card rounded-2xl p-10 md:p-14 border border-[#b8860b]/20 max-w-3xl mx-auto">
