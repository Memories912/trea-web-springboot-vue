...
export default function HeroSection() {
  ...
  return (
    <section className="gsap-hero relative min-h-screen flex flex-col overflow-hidden pt-16">
      {/* Ambient glow orbs — parallax attributes */}
      <div className="absolute top-20 left-1/4 w-96 h-96 bg-[#b8860b]/4 rounded-full blur-[120px] animate-float" style={{ animationDelay: '0s' }} data-parallax-speed="-0.4" />
      <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-[#2c6e6e]/4 rounded-full blur-[100px] animate-float" style={{ animationDelay: '3s' }} data-parallax-speed="0.3" />
        ...
        <div className="section-container relative z-10 w-full py-8 lg:py-12">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Title */}
              <h1 className="gsap-hero-heading">
              ...
              <div className="gsap-stat-section flex gap-6 md:gap-10 pt-8 border-t border-gray-200/60">
                {stats.map((s) => (
                  <div key={s.label} className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="gsap-stat-value text-lg md:text-xl font-extrabold text-[#1a1a2e] leading-tight">
                        {s.value}
                      </div>
